...
const RecentGamePage = () => {
  const { dataRecentPlayed } = useAuthContext();
  console.log("RecentGame", dataRecentPlayed);
  ...
  return (
    <div className="flex flex-col justify-between gap-6 w-full h-full">
      <div className="mt-28 w-full h-auto bg-black/50 rounded-[10px] flex flex-col justify-center items-center gap-8">
        ...
        <div className="w-full px-7 pb-[200px]">
              ...
              >
                <div>
                  <Image
                    ...
                    height={500}
                    alt=""
                    className="w-full object-cover group-hover:scale-110 transition-all rounded-[10px]"
                  />
                </div>
