      ...
      {modal && (
        ...
        >
          <div className="mx-auto mt-[80px] bg-transparent relative max-w-[534px] h-auto">
            ...
            <button className="w-[223.89px] h-[86.22px] rounded-[25px] p-[6px]  bg-gradient-to-tl from-[#FF51EB] to-[#EDE342] text-white font-nunito font-semibold text-[28px] leading-[39.2px] absolute top-[90%] left-[50%] translate-x-[-50%] shadow-[rgba(255,255,255,0.4)_0px_0px_25px_10px]">
