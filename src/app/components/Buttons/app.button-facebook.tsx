...
const ButtonFacebook = () => {
  return (
    <button className="w-[192px] h-9 flex justify-around items-center gap-2 py-[8px] px-[14px] rounded-[20px] font-lato font-bold text-base tracking-[0.2%] leading-[25.6px] bg-white">
      <svg
        width="25"
        height="25"
        viewBox="0 0 25 25"
